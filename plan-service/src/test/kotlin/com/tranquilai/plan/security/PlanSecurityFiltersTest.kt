package com.tranquilai.plan.security

import com.tranquilai.plan.config.InternalServiceKeyFilter
...
class PlanSecurityFiltersTest {
    ...
    @Test
    fun `gateway filter authenticates request from gateway headers`() {
    ...
    @Test
    fun `gateway filter ignores invalid or incomplete gateway headers`() {
        val request = MockHttpServletRequest().apply {
    ...
    @Test
    fun `internal service key filter grants internal role for matching key`() {
        val request = MockHttpServletRequest().apply {
    ...
    @Test
    fun `internal service key filter ignores wrong key`() {
        val request = MockHttpServletRequest().apply {
